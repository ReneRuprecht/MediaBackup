...
class MainView:
    ...
    def __init__(self, master, controller):
        ...
        self.btn_db = Button(self.frame, text="db", width=Buttons.DB_SIZE,
                             command=lambda: controller.open_db_view())

    def show_db_button(self):
    ...
    @staticmethod
    def update_progressbar_value(proressbar, value):
    ...
    @staticmethod
    def set_progressbar_style(progressbar, color):
    ...
    def fill_table(self, file_object_array):
        # fills the table with the file informations
        for i in file_object_array:
    ...
    def reset_form(self):
        ...
        self.set_progressbar_style(self.progressbar_copy, "blue")
        self.set_progressbar_style(self.progressbar_backup, "blue")
